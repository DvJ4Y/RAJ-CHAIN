/**
  * @param {org.rajchain.sendTransaction} tx 
   * @transaction 
   */
   ...
   // Save the old value of the asset.
	...
	if ( tx.value > oldValue ) {
  	...
  	if( tx.asset.owner.type == 'GOVERNMENT'){
        ...
        return getAssetRegistry('org.rajchain.Mudra')
            ...
            return getAssetRegistry('org.rajchain.Mudra')
      		...
      		.then(function (assetRegistry) {
    			...
    			var reciever_asset = factory.newResource('org.rajchain', 'Mudra', reciever_tx_asset_assetId);
